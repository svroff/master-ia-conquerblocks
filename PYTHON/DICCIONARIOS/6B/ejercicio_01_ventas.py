...
total_stock_pre_ventas = total_stock_pre_ventas_peliculas + total_stock_pre_ventas_videojuegos
...
total_stock_post_ventas = total_stock_post_ventas_peliculas + total_stock_post_ventas_videojuegos
