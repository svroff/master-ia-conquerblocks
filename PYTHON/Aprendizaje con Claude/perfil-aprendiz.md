...
4. Python Básico ✅
5. **Python Avanzado ← ESTOY AQUÍ**
6. Matemáticas para IA
7. Estadística y probabilidad
8. Bases de datos y SQL
9. Machine Learning (Scikit-learn, Pandas, NumPy)
10. Deep Learning (TensorFlow, Keras, PyTorch)
11. Procesamiento de Lenguaje Natural (NLP)
12. Visión por computador (CNNs, detección de objetos, segmentación)
13. IA Generativa y LLMs (OpenAI, Hugging Face)
14. Despliegue de modelos (Docker, Cloud)
