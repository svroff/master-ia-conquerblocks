...
> **Fuente de verdad pedagógica.** Si hay conflicto entre este documento y `AGENTS.md` o `CLAUDE.md`, **gana este documento**. `AGENTS.md` es el wrapper operativo para Codex; `CLAUDE.md` se conserva como wrapper para Claude Code.
...
El workflow operativo (memoria, log, tests, commit, push) está en `AGENTS.md` para Codex y en `CLAUDE.md` para Claude Code.
...
## Sistema de memoria
Al inicio de cada sesión, leer `perfil-aprendiz.md`, `estado-actual.md`, `conceptos-python.md` y este fichero para retomar contexto completo.
