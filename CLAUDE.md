...
**Versión de la skill:** 2.1 (2026-07-01 — fusión de dos refactors paralelos: se adopta la jerarquía de fuentes y los guardarraíles de la v2.0, se renombra `Aprendiendo con IA/` a `memoria-aprendizaje/`, y se retira `.opencode/`/`opencode.json` por completo en vez de dejarlos como stub).
